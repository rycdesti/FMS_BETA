    ...
    <b-modal @hide="formReset" @show="formTitle" centered id="form_modal" size="lg"
        ...
        <b-form @submit.prevent="formSubmit" @keydown="form.onKeydown($event)">
            ...
            <b-form-fieldset
                ...
                <b-form-select v-model="form.branch_id"
                               :options="branch_opt"
    ...
    export default {
        ...
        mounted() {
            ...
            axios.all([
                ...
                axios.get('/api/ap/utils/get_branches'),
            ]).then(axios.spread(function (acct_type, currency, branch) {
                component.acct_type_opt = acct_type.data;
                component.currency_opt = currency.data;
                component.branch_opt = branch.data;
            }));
