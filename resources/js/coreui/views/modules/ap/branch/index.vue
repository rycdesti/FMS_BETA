        ...
        <div class="animated fadeIn">
            ...
            <b-row>
                <b-col cols="12">
                    ...
                    >
                        <div slot="header">
                            <i class="fa fa-align-justify"/> <strong>List of Branches</strong>
...
<script>
    import CallOutForm from '@/views/modules/ap/branch/form'
    ...
    export default {
        ...
        mounted() {
            ...
            $(document).on('click', '#btn-bank-account', function () {
                ...
                // var table = $('#tbl-branch').DataTable();
        ...
        methods: {
            filter() {
                ...
                const table = $('#tbl-branch');
                table.DataTable().draw(false);
            },
            fetchData() {
                this.table_url = '/api/ap/branch';
            },
            async deleteData(id) {
                const component = this;
            ...
            async updateStatus(id, status) {
                ...
                if (result.value) {
                    axios.patch(`/api/ap/branch/${id}/update_status`)
                        .then(function (response) {
                            if (response.data.success) {
                                component.$swal.fire(
                                    status,
            ...
            generatePDFReport () {
              const url = '/api/reports/ap/branch';
