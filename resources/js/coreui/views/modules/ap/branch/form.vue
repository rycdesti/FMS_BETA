    ...
    <b-modal @hide="formReset" @show="formTitle" centered id="form_modal" size="lg"
        ...
        <b-form @submit.prevent="formSubmit" @keydown="form.onKeydown($event)">
            ...
            <b-form-fieldset
                ...
                <b-form-input v-model="form.branch_name"
                              autocomplete="off"
                              :class="{ 'is-invalid': form.errors.has('branch_name') }"
                              type="text"
                              class="input-container text-capitalize"
    ...
    export default {
        ...
        methods: {
            ...
            formSubmit: async function () {
                ...
                if (result.value) {
                    const response = is_update ?
                        await this.form.patch(`/api/ap/branch/${this.id}`) : await this.form.post('/api/ap/branch');
            ...
            formTitle() {
                ...
                this.id ? form_modal.text('Edit Branch') : form_modal.text('Add New Branch');
            }
        }
    }
</script>
