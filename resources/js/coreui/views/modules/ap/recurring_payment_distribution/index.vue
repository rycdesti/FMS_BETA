...
<script>
    import CallOutForm from '@/views/modules/ap/recurring_payment_distribution/form'
    ...
    export default {
        ...
        methods: {
            ...
            generatePDFReport () {
              const url = '/api/reports/ap/recurring-payment-distribution/'+this.recurring_payment_id;
