        ...
        <div class="animated fadeIn">
            ...
            <b-row>
                <b-col cols="12">
                    ...
                    >
                        <div slot="header">
                            <i class="fa fa-align-justify"/> <strong>List of Withholding Taxes</strong>
...
<script>
    import CallOutForm from '@/views/modules/ap/withholding_tax/form'
    ...
    export default {
        ...
        data() {
            return {
                table_id: 'tbl-withholding-tax',
                table_columns: [
                    {data: 'description'},
                    {data: 'tax', bSortable: true, bSearchable: false},
        ...
        methods: {
            ...
            fetchData() {
                this.table_url = '/api/ap/withholding-tax';
            },
            async deleteData(id) {
                const component = this;
                ...
                if (result.value) {
                    axios.delete(`/api/ap/withholding-tax/${id}`)
            ...
            async updateStatus(id, status) {
                ...
                if (result.value) {
                    axios.patch(`/api/ap/withholding-tax/${id}/update_status`)
                        .then(function (response) {
                            if (response.data.success) {
                                component.$swal.fire(
                                    status,
            ...
            generatePDFReport () {
              const url = '/api/reports/ap/withholding-tax';
