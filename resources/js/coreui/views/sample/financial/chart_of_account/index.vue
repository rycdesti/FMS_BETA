        ...
        <div class="animated fadeIn">
            ...
            <b-row>
                <b-col cols="12">
                    ...
                    >
                        <div slot="header">
                            <i class="fa fa-align-justify"/> <strong>List of Chart of Accounts</strong>
...
<script>
    import CallOutForm from '@/views/sample/financial/chart_of_account/form'
    ...
    export default {
        ...
        data() {
            return {
                table_id: 'tbl-chart-of-account',
                table_columns: [
                    {data: 'acct_code'},
                    {data: 'information', bSortable: false, bSearchable: false},
                ...
                table_headers: ['Account Code', 'Information', 'Status', 'Logs', 'Actions'],
                table_url: '',
                data: '',
            }
        },
        ...
        methods: {
            fetchData() {
                this.table_url = '/api/financial/chart-of-account';
            },
            async deleteData(id) {
                const component = this;
                ...
                if (result.value) {
                    axios.delete(`/api/financial/chart-of-account/${id}`)
            ...
            async updateStatus(id, status) {
                ...
                if (result.value) {
                    axios.patch(`/api/financial/chart-of-account/${id}/update_status`)
                        .then(function (response) {
                            if (response.data.success) {
                                component.$swal.fire(
                                    status,
