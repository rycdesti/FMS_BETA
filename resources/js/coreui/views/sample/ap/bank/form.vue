    ...
    export default {
        ...
        methods: {
            ...
            formSubmit: async function () {
                ...
                if (result.value) {
                    const response = is_update ?
                        await this.form.patch(`/api/ap/bank/${this.id}`) : await this.form.post('/api/ap/bank');
            ...
            formTitle() {
                ...
                this.id ? form_modal.text('Edit Bank') : form_modal.text('Add New Bank');
            }
        }
    }
</script>
