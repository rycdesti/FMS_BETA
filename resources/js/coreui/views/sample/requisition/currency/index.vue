        ...
        <div class="animated fadeIn">
            ...
            <b-row>
                <b-col cols="12">
                    ...
                    >
                        <div slot="header">
                            <i class="fa fa-align-justify"/> <strong>List of Currencies</strong>
...
<script>
    import CallOutForm from '@/views/sample/requisition/currency/form'
    ...
    export default {
        ...
        data() {
            return {
                ...
                table_headers: ['Description', 'Currency Code', 'Status', 'Logs', 'Actions'],
                table_url: '',
                data: '',
            }
        },
        ...
        methods: {
            ...
            async deleteData(id) {
                ...
                if (result.value) {
                    axios.delete(`/api/requisition/currency/${id}`)
            ...
            async updateStatus(id, status) {
                ...
                if (result.value) {
                    axios.patch(`/api/requisition/currency/${id}/update_status`)
                        .then(function (response) {
                            if (response.data.success) {
                                component.$swal.fire(
                                    status,
